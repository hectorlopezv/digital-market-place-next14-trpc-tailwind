...
export default function ChatWrapper({ fileId }: Props) {
      ...
      >
        <div className="flex-1 flex justify-center items-center flex-col mb-28">
          <div className="flex flex-col items-center gap-2">
            ...
            <h3 className="font-semibold text-xl">Error processing PDF....</h3>
            <p className="text-zinc-500 text-sm">
  ...
  return (
    <ChatContextProvider fileId={fileId}>
      <div
        className="relative min-h-full bg-zinc-50 flex
  divide-y divide-zinc-200 flex-col justify-between gap-2"
      >
