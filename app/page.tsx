  ...
  return (
    <>
      ...
      hover:border-gray-300 hover:bg-white/50"
        ...
        <h1 className="max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl mt-2">
          Chat with your <span className="text-blue-600">documents</span> in
          seconds.
        </h1>
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          Quil allows you to have conversations with any pdf document. Upload
          your file and start asking questions.
        </p>
        ...
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Chatting to your PDF files has never been easier thatn with Quill.
            </p>
          </div>
        </div>
